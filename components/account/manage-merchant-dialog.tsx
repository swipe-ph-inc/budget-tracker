...
interface ManageMerchantDialogProps {
  open: boolean
...
export function ManageMerchantDialog({
  open,
  onOpenChange,
  onCompleted,
}: ManageMerchantDialogProps) {
  ...
  const handleUpdateMerchant = async () => {
    ...
    if (result.success) {
      toast({ title: "Merchant updated", description: "Changes saved successfully." })
      onCompleted?.()
      cancelEdit()
      fetchData()
    } else {
      toast({ title: "Failed to update merchant", description: result.error, variant: "destructive" })
    }
  }
  ...
  const handleDeleteMerchant = async () => {
    ...
    if (result.success) {
      toast({ title: "Merchant deleted", description: "Merchant removed successfully." })
      onCompleted?.()
      setDeleteId(null)
      fetchData()
    } else {
      toast({ title: "Failed to delete merchant", description: result.error, variant: "destructive" })
      setDeleteId(null)
    }
    setIsDeleting(false)
  }
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="flex max-h-[90vh] w-full max-w-[95vw] flex-col sm:max-w-[720px]">
          <DialogHeader>
            <DialogTitle>Manage Merchants</DialogTitle>
            <DialogDescription>
              View, add, edit, and remove merchants. Merchants are used for payments and invoices.
            </DialogDescription>
          </DialogHeader>
          ...
          >
            <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:gap-2">
              ...
              <Button type="submit" size="default" disabled={isAdding || categories.length === 0}>
      ...
      <AlertDialog open={!!deleteId} onOpenChange={(o) => !o && setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this merchant? Payments and invoices linked to this
