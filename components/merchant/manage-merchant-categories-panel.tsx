...
export type ManageMerchantCategoriesPanelProps = {
  onCompleted?: () => void
}

export function ManageMerchantCategoriesPanel({
  onCompleted,
}: ManageMerchantCategoriesPanelProps) {
    ...
    <>
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          View, add, edit, and remove categories. Categories organize merchants
          (e.g. Utilities, Healthcare).
        </p>
      </div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this category? Merchants in this
              category must be moved or deleted first.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
