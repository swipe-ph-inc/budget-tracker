...
const messages = [
  { from: "Budget Partner Support", subject: "Welcome to Budget Partner Pro!", preview: "Thank you for upgrading to Pro. Here's what you can do with your new features...", time: "2 hours ago", read: false, starred: true },
  ...
  { from: "Billing", subject: "Payment Confirmation", preview: "Your payment of $89.99 for Budget Partner Pro has been successfully processed...", time: "2 days ago", read: true, starred: true },
